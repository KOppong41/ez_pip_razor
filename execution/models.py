...
def default_scalper_profile_config() -> dict:
    ...
    return {
        ...
        "default_strategy_profile": "core_standard",
        "strategy_profiles": {
            "core_standard": {
                "name": "Core Scalper – Standard",
                "symbol": None,
                "execution_timeframes": ["M1"],
                "description": "Balanced scalper mix: trend pullback + breakout retest with pin-bar confirmations.",
            ...
            "core_aggressive": {
                "name": "Core Scalper – Aggressive",
                "symbol": None,
                "execution_timeframes": ["M1"],
                "description": "Higher frequency: add momentum ignition on top of the core set.",
            ...
            "eurusd_intraday": {
                ...
                "description": "EURUSD mix prioritising trend pullbacks with selective range fades during quieter sessions.",
                "enabled_strategies": ["trend_pullback", "doji_breakout", "range_reversion"],
                "internal_triggers": ["price_action_pinbar"],
                "disabled_strategies": ["momentum_ignition"],
            },
            "gbpusd_intraday": {
                "name": "GBPUSD Intraday",
                "symbol": "GBPUSD",
                "execution_timeframes": ["M1", "M5"],
                "description": "GBPUSD set favouring structure-friendly pullbacks and breakout retests during London/NY overlap.",
                "enabled_strategies": ["trend_pullback", "breakout_retest", "price_action_pinbar"],
                "internal_triggers": ["doji_breakout"],
                "disabled_strategies": ["momentum_ignition"],
            },
            # Backward-compatible aliases to avoid breaking existing bots referencing old keys.
            "xauusd_standard": {
                "name": "Core Scalper – Standard (legacy key)",
                "symbol": None,
                "execution_timeframes": ["M1"],
                "description": "Balanced scalper mix: trend pullback + breakout retest with pin-bar confirmations.",
                "enabled_strategies": ["trend_pullback", "breakout_retest"],
            ...
            "xauusd_aggressive": {
                "name": "Core Scalper – Aggressive (legacy key)",
                "symbol": None,
                "execution_timeframes": ["M1"],
                "description": "Higher frequency: add momentum ignition on top of the core set.",
                "enabled_strategies": ["trend_pullback", "breakout_retest", "momentum_ignition"],
        ...
        "default_risk_preset": "core_standard",
        "risk_presets": {
            "core_standard": {
                "name": "Standard",
                "tp_pips": 120,
            ...
            "xauusd_standard": {
                "name": "Standard (legacy key)",
                "tp_pips": 120,
                "sl_pips": 70,
                "kill_switch_pct": 5.0,
            },
            "xauusd_aggressive": {
                "name": "Aggressive (legacy key)",
                "tp_pips": 150,
                "sl_pips": 80,
                "kill_switch_pct": 7.0,
                "risk_pct": 0.7,
